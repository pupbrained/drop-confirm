...
import net.neoforged.fml.common./^? if <1.21.1 {^//^Mod.^//^?}^/EventBusSubscriber
import net.neoforged.neoforge.client./^? if <1.21.1 {^//^ConfigScreenHandler.ConfigScreenFactory^//^?} else {^/gui.IConfigScreenFactory as ConfigScreenFactory/^?}^/
